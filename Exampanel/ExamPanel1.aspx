...
<body style="overflow:hidden;">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="your-logo.png" alt="Logo" width="40" height="40" class="d-inline-block align-text-top me-2">
                Exam Application
            </a>
            ...
            <div class="d-flex align-items-center">
                ...
                <asp:Label ID="lblUserName" runat="server" CssClass="text-white ms-2"></asp:Label>
            </div>
        </div>
    </nav>
    ...
    <div class="bg-light p-3 text-center">
        <h4><asp:Label ID="lblExamTitle" runat="server" Text="Exam Title Here"></asp:Label></h4>
    </div>
    ...
    <div class="container-fluid mt-3">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="mb-3">
                    <span class="badge bg-success mb-2 d-block">Answered: <asp:Label ID="lblAnswered" runat="server" Text="0"></asp:Label></span>
                    <span class="badge bg-danger mb-2 d-block">Not Answered: <asp:Label ID="lblNotAnswered" runat="server" Text="0"></asp:Label></span>
                    <span class="badge bg-warning mb-2 d-block">Not Visited: <asp:Label ID="lblNotVisited" runat="server" Text="0"></asp:Label></span>
                    <span class="badge bg-primary mb-2 d-block">Marked for Review: <asp:Label ID="lblMarkedReview" runat="server" Text="0"></asp:Label></span>
                </div>
